...
const PillNav = ({
  ...
  return (
    <div className="relative top-[1em] z-[1000] w-full flex justify-center px-4 md:px-0">
      <nav
        className={`w-full md:w-max flex justify-between items-center box-border ${className}`}
        aria-label="Primary"
        style={cssVars}
      >
